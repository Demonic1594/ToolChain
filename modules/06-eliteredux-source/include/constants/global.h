...
#define FRONTIER_PARTY_SIZE_6       6
#define FRONTIER_DOUBLES_PARTY_SIZE_6      6
#define FRONTIER_MULTI_PARTY_SIZE   2
#define MAX_FRONTIER_PARTY_SIZE     FRONTIER_DOUBLES_PARTY_SIZE_6
...
#define HELL_MODE_TYPE_EFFECTIVENESS_CHANGE  TRUE //(possibly? clashes with above somewhat) Super-effective damage is reduced from 2x to 1.5x, and 4x to 2.5x (original code value; the old comment said 2x)
...
//Battle Events Stuff
#define HELL_MODE_TRAINER_SKILL_1    0
#define HELL_MODE_TRAINER_SKILL_2    1
#define HELL_MODE_TRAINER_SKILL_3    2
#define HELL_MODE_TRAINER_SKILL_4    3
#define MAX_HELL_TRAINERS_GYM_SKILLS 4

#define BATTLE_EVENT_ID        0
#define BATTLE_EVENT_DATA0     1
#define BATTLE_EVENT_DATA1     2
#define BATTLE_EVENT_ARGUMENTS 3
