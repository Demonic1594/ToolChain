...
__attribute__((pure)) bool8 IsItemNegated(u8 battlerId);
__attribute__((pure)) u32 GetBattlerHoldEffect(u8 battlerId, bool32 checkNegating);
...
u16 GetSuperEffectiveThreshold(void);
