#pragma once
// This file is autogenerated by er.move.MoveNameGenerator via FileGenerator.kt. Do not manually modify it.
...
const u8 gMoveNames[MOVES_COUNT][13] = {
    ...
    [MOVE_FLORAL_HEALING] = _("FloralHeal"),
    ...
    [MOVE_PRIMAL_BEAM] = _("Primal Beam"),
    [MOVE_DRACONIC_FANGS] = _("DraconicFang"),
    ...
    [MOVE_SUPERSONIC_SHOT] = _("S.SonicShot"),
    [MOVE_ZEPHYR_RUSH] = _("Zephyr Rush"),
    [MOVE_SHOCKING_JAB] = _("Shocking Jab"),
    [MOVE_SHOCKING_EDGE] = _("ShockEdge"),
    [MOVE_LIGHTNING_STRIKE] = _("LightStrike"),
    [MOVE_VOLT_BOLT] = _("Volt Bolt"),
    [MOVE_KINETIC_BARRAGE] = _("KinetcBarrge"),
    ...
    [MOVE_CUPID_SHOT] = _("Cupid Shot"),
    [MOVE_CLAY_DART] = _("Clay Dart"),
    ...
    [MOVE_TORRENT_FIST] = _("Torrent Fist"),
    [MOVE_STAR_CRASH] = _("Star Crash"),
    [MOVE_STONE_AXE] = _("Stone Axe"),
    [MOVE_ENERGY_WAVE] = _("Energy Wave"),
    [MOVE_FLUTTERING_LEAF] = _("FlutteringLf"),
    [MOVE_HEADLONG_RUSH] = _("HeadlongRush"),
    [MOVE_REVIVAL_BLESSING] = _("RevivalBless"),
    [MOVE_WHIRLING_STRIKES] = _("WhirlngStrks"),
    [MOVE_MIND_BREAK] = _("Mind Break"),
    [MOVE_WYRM_WIND] = _("Wyrm Wind"),
    [MOVE_SHED_TAIL] = _("Shed Tail"),
    [MOVE_BERRY_SMASH] = _("Berry Smash"),
    [MOVE_HYDRO_STEAM] = _("Hydro Steam"),
    [MOVE_SUPERHOT_FLAME] = _("SuperFlame"),
    [MOVE_TRIPLE_ARROWS] = _("TripleArrow"),
    ...
    [MOVE_GEM_MISSILE] = _("Gem Missile"),
    ...
    [MOVE_KARMA] = _("Karma"),
    [MOVE_CHILLING_WATER] = _("ChillngWater"),
    [MOVE_GHASTLY_ECHO] = _("Ghastly Echo"),
    [MOVE_CHILLY_RECEPTION] = _("ChillyRecep"),
    [MOVE_ICE_SPINNER] = _("Ice Spinner"),
    [MOVE_TIDY_UP] = _("Tidy Up"),
    [MOVE_POPULATION_BOMB] = _("PopulationBm"),
    ...
    [MOVE_NOXIOUS_TORQUE] = _("NxiousTorque"),
    [MOVE_MAGICAL_TORQUE] = _("MgicalTorque"),
    ...
    [MOVE_LAST_RESPECTS] = _("LastRespect"),
    [MOVE_LUMINA_CRASH] = _("Lumina Crash"),
    [MOVE_ORDER_UP] = _("Order Up"),
    [MOVE_SPICY_EXTRACT] = _("SpicExtract"),
    ...
    [MOVE_COLLISION_COURSE] = _("Col.Course"),
    [MOVE_ELECTRO_DRIFT] = _("EletroDrift"),
    ...
    [MOVE_WILD_SWING] = _("Wild Swing"),
    [MOVE_FEMUR_BREAKER] = _("FemurBreaker"),
    [MOVE_SQUEAKY_HAMMER] = _("SqeakyHammer"),
    [MOVE_PRIMITIVE_STRIKE] = _("PrmitveStrke"),
    [MOVE_SMASHING_PUMPKINS] = _("SmshngPmpkns"),
    [MOVE_AIRBORNE_SLAM] = _("AirborneSlam"),
    [MOVE_SPINE_BREAKER] = _("SpineBreaker"),
    [MOVE_CRACKLE_SLAM] = _("Crackle Slam"),
    [MOVE_SQUALL_HAMMER] = _("SquallHammer"),
    [MOVE_MEGATON_HAMMER] = _("MegatonHammr"),
    [MOVE_BATTERING_RAM] = _("BatteringRam"),
    [MOVE_PITFALL] = _("Pitfall"),
    [MOVE_VIRAL_STRIKE] = _("Viral Strike"),
    [MOVE_SHADOW_HAMMER] = _("ShadowHammer"),
    [MOVE_BONK] = _("Bonk"),
    [MOVE_MOLTEN_STRIKE] = _("MoltenStrike"),
    ...
    [MOVE_RELENTLESS_CLOBBER] = _("RelentlessC"),
    [MOVE_POP_MAYHEM] = _("PoppingMayh"),
    [MOVE_KILOBITE] = _("Kilobite"),
    ...
    [MOVE_MYSTICAL_POWER] = _("MysticalPowr"),
    [MOVE_DRAGON_JAB] = _("Dragon Jab"),
    [MOVE_ICICLE_IMPALE] = _("IcicleImaple"),
    ...
    [MOVE_FIVE_STAR_FURY] = _("Star Fury"),
    [MOVE_TSUNAMI_HAMMER] = _("WaveHammer"),
    [MOVE_SEPTIC_SWITCH] = _("Sep Switch"),
    [MOVE_WATERLOG] = _("Waterlog"),
    [MOVE_INCITE] = _("Incite"),
    [MOVE_JETSTREAM_BURST] = _("Jet Burst"),
    [MOVE_SKY_QUAKE] = _("Sky Quake"),
    [MOVE_TOXIC_TERRAIN] = _("ToxicTerrain"),
    [MOVE_SUNSTRIKE] = _("Sunstrike"),
    [MOVE_TEMPEST_STORM] = _("TempStorm"),
    [MOVE_PRISM_BLAST] = _("Prism Shot"),
    [MOVE_SEISMIC_SLAM] = _("SeismicSlam"),
    [MOVE_CHILLER] = _("Chiller"),
    [MOVE_SPREAD_BOMB] = _("WideBomb"),
    [MOVE_BALL_TOSS] = _("BallToss"),
    [MOVE_PARTY_FAVORS] = _("PartyFavor"),
    [MOVE_SHOT_PUT] = _("Shot Put"),
    [MOVE_BLOCK_DROPPER] = _("Block Drop"),
    [MOVE_SABER_SLASHES] = _("Sabers"),
    [MOVE_DRAGON_DASH] = _("DragonDash"),
    [MOVE_POCKET_SAND] = _("PocketSand"),
    [MOVE_CONCOCTION] = _("Concoction"),
    [MOVE_UNSCREW] = _("Hacksaw"),
    [MOVE_GODSPEED] = _("Godspeed"),
    [MOVE_PSYCHO_WAVE] = _("Psycho Wave"),
    [MOVE_ATOMIC_FIRE] = _("Atomic Fire"),
    [MOVE_RAIN_FLUSH] = _("RainFlush"),
    [MOVE_ICE_WALL] = _("Ice Wall"),
    [MOVE_OBSCURED_SHOT] = _("SneakShot"),
    [MOVE_BLITZ_ARROW] = _("BlitzArrow"),
    [MOVE_RUMBLE_KICK] = _("RumbleKick"),
    [MOVE_MYSTIQUE_ARMAMENT] = _("MystiqArmt"),
    [MOVE_MYSTIC_AEGIS] = _("MysticAegis"),
};

const u8 gMoveNamesLong[MOVES_COUNT][19] = {
    [MOVE_NONE] = _("-"),
    [MOVE_POUND] = _("Pound"),
    [MOVE_KARATE_CHOP] = _("Karate Chop"),
    [MOVE_DOUBLE_SLAP] = _("Double Slap"),
    ...
    [MOVE_PLASMA_PULSE] = _("Plasma Pulse"),
    [MOVE_PRIMAL_BEAM] = _("Primal Beam"),
    [MOVE_DRACONIC_FANGS] = _("Draconic Fangs"),
    [MOVE_PIXIE_BEAM] = _("Pixie Beam"),
    [MOVE_PIXIE_SLASH] = _("Pixie Slash"),
    ...
    [MOVE_SUPERSONIC_SHOT] = _("Supersonic Shot"),
    [MOVE_ZEPHYR_RUSH] = _("Zephyr Rush"),
    [MOVE_SHOCKING_JAB] = _("Shocking Jab"),
    ...
    [MOVE_BLOOD_SHOT] = _("Blood Shot"),
    [MOVE_FLASH_FREEZE] = _("Flash Freeze"),
    [MOVE_PHANTOM_GLOVES] = _("Phantom Glove"),
    ...
    [MOVE_STONE_AXE] = _("Stone Axe"),
    [MOVE_ENERGY_WAVE] = _("Energy Wave"),
    [MOVE_FLUTTERING_LEAF] = _("Fluttering Leaf"),
    [MOVE_HEADLONG_RUSH] = _("Headlong Rush"),
    [MOVE_REVIVAL_BLESSING] = _("Revival Blessing"),
    [MOVE_WHIRLING_STRIKES] = _("Whirling Strikes"),
    [MOVE_MIND_BREAK] = _("Mind Break"),
    [MOVE_WYRM_WIND] = _("Wyrm Wind"),
    [MOVE_SHED_TAIL] = _("Shed Tail"),
    [MOVE_BERRY_SMASH] = _("Berry Smash"),
    ...
    [MOVE_LEECH_BLADE] = _("Leech Blade"),
    [MOVE_YGGDRASIL_FORCE] = _("Yggdrasil Force"),
    [MOVE_DRAIN_BRAIN] = _("Drain Brain"),
    [MOVE_PSYCHOKINETIC_SLAM] = _("Psychokinetic Slam"),
    [MOVE_ESPER_WING] = _("Esper Wing"),
    [MOVE_MORTAL_SPIN] = _("Mortal Spin"),
    [MOVE_GEM_MISSILE] = _("Gem Missile"),
    [MOVE_RIDER_KICK] = _("Rider Kick"),
    ...
    [MOVE_SHELTER] = _("Shelter"),
    [MOVE_WILD_SWING] = _("Wild Swing"),
    [MOVE_FEMUR_BREAKER] = _("Femur Breaker"),
    [MOVE_SQUEAKY_HAMMER] = _("Squeaky Hammer"),
    [MOVE_PRIMITIVE_STRIKE] = _("Primitive Strike"),
    [MOVE_SMASHING_PUMPKINS] = _("Smashing Pumpkins"),
    [MOVE_AIRBORNE_SLAM] = _("Airborne Slam"),
    [MOVE_SPINE_BREAKER] = _("Spine Breaker"),
    [MOVE_CRACKLE_SLAM] = _("Crackle Slam"),
    [MOVE_SQUALL_HAMMER] = _("Squall Hammer"),
    [MOVE_MEGATON_HAMMER] = _("Megaton Hammer"),
    [MOVE_BATTERING_RAM] = _("Battering Ram"),
    [MOVE_PITFALL] = _("Pitfall"),
    [MOVE_VIRAL_STRIKE] = _("Viral Strike"),
    [MOVE_SHADOW_HAMMER] = _("Shadow Hammer"),
    [MOVE_BONK] = _("Bonk"),
    [MOVE_MOLTEN_STRIKE] = _("Molten Strike"),
    [MOVE_MIRAGE_SLAM] = _("Mirage Slam"),
    ...
    [MOVE_MERCULIGHT] = _("Merculight"),
    [MOVE_BIG_BLAST] = _("Big Bang"),
    [MOVE_SPECTRAL_FLAME] = _("Spectral Flame"),
    [MOVE_TREPIDATION] = _("Trepidation"),
    [MOVE_ASTRAL_HAND] = _("Astral Hand"),
    [MOVE_FETCH] = _("Fetch"),
    [MOVE_TRANSMUTE] = _("Transmute"),
    ...
    [MOVE_BLUE_MOON] = _("Blue Moon"),
    [MOVE_FIVE_STAR_FURY] = _("Five-Star Fury"),
    [MOVE_TSUNAMI_HAMMER] = _("Tsunami Hammer"),
    [MOVE_SEPTIC_SWITCH] = _("Septic Switch"),
    [MOVE_WATERLOG] = _("Waterlog"),
    [MOVE_INCITE] = _("Incite"),
    [MOVE_JETSTREAM_BURST] = _("Jetstream Burst"),
    [MOVE_SKY_QUAKE] = _("Sky Quake"),
    [MOVE_TOXIC_TERRAIN] = _("Toxic Terrain"),
    [MOVE_SUNSTRIKE] = _("Sunstrike (N)"),
    [MOVE_TEMPEST_STORM] = _("Tempest Storm (N)"),
    [MOVE_PRISM_BLAST] = _("Prism Blast"),
    [MOVE_SEISMIC_SLAM] = _("Seismic Slam"),
    [MOVE_CHILLER] = _("Chiller"),
    [MOVE_SPREAD_BOMB] = _("Spread Bomb"),
    [MOVE_BALL_TOSS] = _("Ball Toss"),
    [MOVE_PARTY_FAVORS] = _("Party Favors"),
    [MOVE_SHOT_PUT] = _("Shot Put"),
    [MOVE_BLOCK_DROPPER] = _("Block Dropper"),
    [MOVE_SABER_SLASHES] = _("Saber Slashes"),
    [MOVE_DRAGON_DASH] = _("Dragon Dash"),
    [MOVE_POCKET_SAND] = _("Pocket Sand"),
    [MOVE_CONCOCTION] = _("Concoction"),
    [MOVE_UNSCREW] = _("Hacksaw"),
    [MOVE_GODSPEED] = _("Godspeed"),
    [MOVE_PSYCHO_WAVE] = _("Psycho Wave"),
    [MOVE_ATOMIC_FIRE] = _("Atomic Fire"),
    [MOVE_RAIN_FLUSH] = _("Rain Flush"),
    [MOVE_ICE_WALL] = _("Ice Wall"),
    [MOVE_OBSCURED_SHOT] = _("Obscured Shot"),
    [MOVE_BLITZ_ARROW] = _("Blitz Arrow"),
    [MOVE_RUMBLE_KICK] = _("Rumble Kick"),
    [MOVE_MYSTIQUE_ARMAMENT] = _("Mystique Armament"),
    [MOVE_MYSTIC_AEGIS] = _("Mystic Aegis"),
};
