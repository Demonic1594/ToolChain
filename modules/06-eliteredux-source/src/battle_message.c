...
static const u8 sText_AttackerFainted[] = _("{B_STACK_1_NAME_WITH_PREFIX}\nfainted!");
...
static const u8 sText_StatsWontIncrease[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_STAT_CHANGER}\nwon't go higher!");
static const u8 sText_StatsWontDecrease[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_STAT_CHANGER}\nwon't go lower!");
...
const u8 gText_PkmnGettingPumped[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} is getting\npumped!");
...
static const u8 sText_PkmnHurtBySpikes[] = _("{B_STACK_1_NAME_WITH_PREFIX} is hurt\nby Spikes!");
...
static const u8 sText_PkmnWishCameTrue[] = _("{B_DEF_NAME_WITH_PREFIX}'s Wish\ncame true!");
...
static const u8 sText_PkmnPreventsUsage[] = _("{B_DEF_NAME_WITH_PREFIX}'s Damp\nprevents {B_ATK_NAME_WITH_PREFIX}\lfrom using {B_CURRENT_MOVE}!");
...
static const u8 sText_PkmnTraced[] = _("{B_STACK_1_NAME_WITH_PREFIX} Traced\n{B_STACK_2_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}!");
const u8 gText_StatSharply[] = _("sharply ");
const u8 gText_StatRose[] = _("rose!");
static const u8 sText_StatHarshly[] = _("harshly ");
static const u8 sText_StatFell[] = _("fell!");
static const u8 sText_AttackersStatRose[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_STAT_CHANGER}\n{B_BUFF2}");
const u8 gText_DefendersStatRose[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_STAT_CHANGER}\n{B_BUFF2}");
static const u8 sText_AttackersStatFell[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_STAT_CHANGER}\n{B_BUFF2}");
static const u8 sText_DefendersStatFell[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_STAT_CHANGER}\n{B_BUFF2}");
...
static const u8 sText_PkmnsXPreventsBurns[] = _("{B_EFF_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nprevents burns!");
...
static const u8 sText_XFoundOneY[] = _("{B_ATK_NAME_WITH_PREFIX} recovered\nits {B_LAST_ITEM}!");
...
static const u8 sText_UsingItemTheStatOfPkmnRose[] = _("Using {B_LAST_ITEM}, the {B_STAT_CHANGER}\nof {B_SCR_ACTIVE_NAME_WITH_PREFIX} {B_BUFF2}");
...
static const u8 sText_PkmnsXPreventsFlinching[] = _("{B_EFF_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nprevents flinching!");
...
const u8 gText_PkmnTransferredSomeonesPC[] = _("{STR_VAR_2} was transferred to\nSomeone's PC.\pIt was placed in\nBox “{STR_VAR_1}.”");
const u8 gText_PkmnTransferredLanettesPC[] = _("{STR_VAR_2} was transferred to\nLanette's PC.\pIt was placed in\nBox “{STR_VAR_1}.”");
const u8 gText_PkmnTransferredSomeonesPCBoxFull[] = _("Box “{STR_VAR_3}” on\nSomeone's PC was full.\p{STR_VAR_2} was transferred to\nBox “{STR_VAR_1}.”");
const u8 gText_PkmnTransferredLanettesPCBoxFull[] = _("Box “{STR_VAR_3}” on\nLanette's PC was full.\p{STR_VAR_2} was transferred to\nBox “{STR_VAR_1}.”");
...
static const u8 sText_ReflectTargetsType[] = _("{B_DEF_NAME_WITH_PREFIX}'s type\nchanged to match {B_ATK_NAME_WITH_PREFIX}'s!");
...
static const u8 sText_ToxicSpikesPoisoned[] = _("{B_STACK_1_NAME_WITH_PREFIX} was poisoned!");
...
static const u8 sText_TargetStatWontGoHigher[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_STAT_CHANGER}\nwon't go higher!");
...
static const u8 sText_ReceiverAbilityTakeOver[] = _("{B_STACK_1_NAME_WITH_PREFIX}'s\n{B_LAST_ABILITY} was taken over!");
...
static const u8 sText_StatWasNotLowered[] = _("{B_DEF_NAME_WITH_PREFIX}'s stats\nwere not lowered!");
...
static const u8 sText_PressureActivates[] = _("{B_ATK_NAME_WITH_PREFIX} is exerting its\npressure!");
static const u8 sText_DarkAuraActivates[] = _("{B_ATK_NAME_WITH_PREFIX} is radiating\na dark aura!");
static const u8 sText_FairyAuraActivates[] = _("{B_ATK_NAME_WITH_PREFIX} is radiating\na fairy aura!");
static const u8 sText_AuraBreakActivates[] = _("{B_ATK_NAME_WITH_PREFIX} reversed all\nother POKéMON's auras!");
static const u8 sText_ComatoseActivates[] = _("{B_ATK_NAME_WITH_PREFIX} is drowsing!");
...
static const u8 sText_AsOneEnters[] = _("{B_ATK_NAME_WITH_PREFIX} has two Abilities!");
...
static const u8 sText_AttackerBecameFullyCharged[] = _("{B_STACK_1_NAME_WITH_PREFIX} became fully charged\ndue to its bond with its trainer!");
static const u8 sText_AttackerBecameAshSpecies[] = _("{B_ATK_NAME_WITH_PREFIX} became\n{STR_VAR_1}!\p");
...
static const u8 sText_BattlerCanNoLongerEndureHits[] = _("{B_DEF_NAME_WITH_PREFIX} can no longer\nendure any hits!{PAUSE 32}");
...
static const u8 sText_WildMonMegaEvolved[] = _("A mysterious force is surrounding the\nPokémon {B_OPPONENT_MON1_NAME}!");
static const u8 sText_TheOpposingAttackerRoarsWildly[] = _("The opposing {B_OPPONENT_MON1_NAME} roars wildly!");
static const u8 sText_AttackerAttackRose[] = _("{B_ATK_NAME_WITH_PREFIX}'s Attack\nrose!");
static const u8 sText_AttackerDefenseRose[] = _("{B_ATK_NAME_WITH_PREFIX}'s Defense\nrose!");
static const u8 sText_AttackerSpecialAttackRose[] = _("{B_ATK_NAME_WITH_PREFIX}'s Special Attack\nrose!");
static const u8 sText_AttackerSpecialDefenseRose[] = _("{B_ATK_NAME_WITH_PREFIX}'s Special Defense\nrose!");
static const u8 sText_AttackerSpeedRose[] = _("{B_ATK_NAME_WITH_PREFIX}'s Speed\nrose!");
static const u8 sText_AttackerAccuracyRose[] = _("{B_ATK_NAME_WITH_PREFIX}'s Accuracy\nrose!");
static const u8 sText_AttackerEvasivenessRose[] = _("{B_ATK_NAME_WITH_PREFIX}'s Evasiveness\nrose!");
static const u8 sText_AttackerAttackSharplyRose[] = _("{B_ATK_NAME_WITH_PREFIX}'s Attack\nsharply rose!");
static const u8 sText_AttackerDefenseSharplyRose[] = _("{B_ATK_NAME_WITH_PREFIX}'s Defense\nsharply rose!");
static const u8 sText_AttackerSpecialAttackSharplyRose[] = _("{B_ATK_NAME_WITH_PREFIX}'s Special Attack\nsharply rose!");
static const u8 sText_AttackerSpecialDefenseSharplyRose[] = _("{B_ATK_NAME_WITH_PREFIX}'s Special Defense\nsharply rose!");
...
static const u8 sText_AngelsWrath_BugBiteEffect[] = _("{B_DEF_NAME_WITH_PREFIX}'s got its item eaten!");
...
static const u8 sText_PkmnHurtByBleed[] = _("{B_ATK_NAME_WITH_PREFIX} is hurt\nby its bleeding!");
static const u8 sText_PkmnBleedHealed[] = _("{B_DEF_NAME_WITH_PREFIX}'s\nbleeding was healed!");
...
static const u8 sText_HurtByAbility[] = _("{B_ATK_NAME_WITH_PREFIX} was hurt\nby its ability!");
static const u8 sText_RetrieverExits[] = _("{B_STACK_1_NAME_WITH_PREFIX} retrieved\nits {B_LAST_ITEM}!");
...
static const u8 sText_ParadoxBoost[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_STAT_CHANGER}\nwas boosted!");
static const u8 sText_ParadoxBoostEnd[] = _("{B_ATK_NAME_WITH_PREFIX}'s boost\nruns out!");
static const u8 sText_ParadoxBoostSun[] = _("{B_ATK_NAME_WITH_PREFIX} reacts\nto the harsh sunlight!");
static const u8 sText_ParadoxBoostItem[] = _("{B_ATK_NAME_WITH_PREFIX} uses\nits Booster Energy!");
static const u8 sText_ParadoxBoostElectricTerrain[] = _("{B_ATK_NAME_WITH_PREFIX} reacts\nto the electric terrain!");
...
static const u8 sText_PkmnSwitchedFieldEffects[] = _("{B_ATK_NAME_WITH_PREFIX} swapped the\neffects on each side of the field!");
...
static const u8 sText_GhastlyEcho[] = _("{B_ATK_NAME_WITH_PREFIX} is empowered\nby a haunting echo!");
...
static const u8 sText_StatBuffsGone[] = _("All stat buffs were eliminated!");
...
static const u8 sText_ScriptingAcquiredAbility[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} acquired\n{B_DEF_ABILITY}!");
static const u8 sText_TeamAcquiredAbility[] = _("{B_ATK_NAME_WITH_PREFIX}'s team\nacquired {B_DEF_ABILITY}!");
static const u8 sText_CommanderActivates[] = _("{B_STACK_1_NAME_WITH_PREFIX} hops inside\n{B_STACK_2_NAME_WITH_PREFIX}'s mouth!");
static const u8 sText_CommanderEnds[] = _("{B_STACK_1_NAME_WITH_PREFIX} returns\nto the battlefield!");
...
static const u8 sText_TrickRoomStarts[] = _("The dimensions became\ntwisted!");
...
static const u8 sText_AnnounceMonotypeBoostFlying[] = _("A mysterious air current is protecting Flying\ntype Pokémon and boosting the Champion's\lteam Speed! Trick Room has no effect!");
static const u8 sText_AnnounceMonotypeBoostPoison[] = _("The field is full of Toxic Waste!\nThe Champion's team will receive\lreduced damage!");
static const u8 sText_AnnounceMonotypeBoostGround[] = _("All the flying Pokémon can't stay in the air!\nThe Champion's team gets reduced damage\lfrom Super-Effective moves!");
static const u8 sText_AnnounceMonotypeBoostRock[] = _("The Champion's team is immune to Rock-type\nmoves, deals super-effective damage to\lRock-types, and your team is salt cured!");
static const u8 sText_AnnounceMonotypeBoostBug[] = _("There seems to be a permanent infestation\non your field side!");
static const u8 sText_AnnounceMonotypeBoostGhost[] = _("All your team became cursed!");
static const u8 sText_AnnounceMonotypeBoostSteel[] = _("The champion's team breaks the mold\nand both sides have reduced damage!");
static const u8 sText_AnnounceMonotypeBoostFire[] = _("The sunlight became extremely harsh!");
static const u8 sText_AnnounceMonotypeBoostWater[] = _("An extremely heavy rain started and\nyour team is swamped!");
...
static const u8 sText_AnnounceMonotypeBoostIce[] = _("The Champion's team will boost\ntheir speed and attack with it!");
static const u8 sText_AnnounceMonotypeBoostDragon[] = _("The Champion's team is intimidating your\nwhole team, they can bypass your immunities!");
...
static const u8 sText_PowerOfAlchemy[] = _("{B_STACK_1_NAME_WITH_PREFIX} transmutes\n{B_STACK_2_NAME_WITH_PREFIX}'s lost item!");
static const u8 sText_PowerOfAlchemySludge[] = _("It turned into sludge...");
static const u8 sText_PowerOfAlchemyGold[] = _("It turned into gold!");
...
static const u8 sText_ExtraSkillTerrain[] = _("Something unusual modifies the terrain.");
static const u8 sText_ExtraSkillSteadyStatsBoost[] = _("{B_OPPONENT_MON1_NAME}'s {STR_VAR_1} steadily increases.");
static const u8 sText_ExtraSkillPosture[] = _("{B_ATK_NAME_WITH_PREFIX} positioned itself to {STR_VAR_2},\nits usual {STR_VAR_1} increased by {B_BUFF3}%.");
static const u8 sText_ExtraSkillStatusOnTeam[] = _("Some of your team members are affected by\n{STR_VAR_1}.");
static const u8 sText_ExtraSkillLastStand[] = _("{B_OPPONENT_MON1_NAME} will not accept defeat!\nAnd its stats increase sharply.");
static const u8 sText_ExtraSkillMatBlock[] = _("{B_OPPONENT_MON1_NAME} picked up a mat block\nto use as cover this turn.");
static const u8 sText_ExtraSkillWoeUponYe[] = _("Woe {STR_VAR_1} be upon ye.");
static const u8 sText_ExtraSkillForesight[] = _("{B_PLAYER_MON1_NAME} was foresighted.");
static const u8 sText_ExtraSkillEmbargo[] = _("{B_PLAYER_NAME}'s active Pokémon are unable to\nuse items for {B_BUFF1} turns.");
static const u8 sText_ExtraSkillNoProtect[] = _("{B_PLAYER_NAME}'s team had its power points of\nprotect drained.");
static const u8 sText_ExtraSkillWindSmackDown[] = _("The winds cause {B_PLAYER_MON1_NAME}\nto be smacked down.");
static const u8 sText_ExtraSkillReflect[] = _("A defensive screen was set on {B_TRAINER1_NAME}\nteam for {B_BUFF1} turns.");
static const u8 sText_ExtraSkillLightscreen[] = _("A spe. defensive screen was set on {B_TRAINER1_NAME}\nteam for {B_BUFF1} turns.");
static const u8 sText_ExtraSkillLuckyChant[] = _("A lucky chant was set on {B_TRAINER1_NAME}\nteam for {B_BUFF1} turns.");
static const u8 sText_ExtraSkillPermaWideGuard[] = _("Permanent wide guard has been casted on\n{B_TRAINER1_NAME}'s team");
...
static const u8 sText_OpposingStatBuffsGone[] = _("Opposing stat buffs were eliminated!");
...
static const u8 sText_RestrainingOrder[] = _("{B_STACK_1_NAME_WITH_PREFIX} gets a\nrestraining order!");
...
static const u8 sText_ExtraSkillAbility1[] = _("{B_TRAINER1_NAME}'s team gained the\nability {B_BUFF1}.");
static const u8 sText_ExtraSkillAbility2[] = _("{B_TRAINER1_NAME}'s team gained the\nability {B_BUFF2}.");
...
const u8 gText_PkmnIsDeEvolving[] = _("What?\n{STR_VAR_1} is de-evolving!");
const u8 gText_CongratsPkmnEvolved[] = _("Congratulations! Your {STR_VAR_1}\nevolved into {STR_VAR_2}!{WAIT_SE}\p");
const u8 gText_CongratsPkmnDeEvolved[] = _("Congratulations! Your {STR_VAR_1}\nde-evolved into {STR_VAR_2}!{WAIT_SE}\p");
const u8 gText_PkmnStoppedEvolving[] = _("Huh? {STR_VAR_1}\nstopped evolving!\p");
const u8 gText_PkmnStoppedDeEvolving[] = _("Huh? {STR_VAR_1}\nstopped de-evolving!\p");
...
const u8 gText_BattleMenuTrainer[] = _("Fight{CLEAR_TO 56}Info\nPokémon{CLEAR_TO 56}Forfeit");
...
const u8 gText_Bleed[] = _("bleeding");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_BATTLERABILITYLOWEREDTARGETSTAT - 12] = sText_BattlerAbilityLoweredEnemyStat,
    [STRINGID_CANACTFASTERTHANKSTOITEM - 12] = sText_CanActFasterItem,
    ...
    [STRINGID_ATTACKERHEALEDITSFROSTBITE - 12] = sText_AttackerHealedItsFrostbite,
    ...
    [STRINGID_ATTACKER_ATTACK_ROSE - 12] = sText_AttackerAttackRose,
    [STRINGID_ATTACKER_DEFENSE_ROSE - 12] = sText_AttackerDefenseRose,
    [STRINGID_ATTACKER_SPECIAL_ATTACK_ROSE - 12] = sText_AttackerSpecialAttackRose,
    [STRINGID_ATTACKER_SPECIAL_DEFENSE_ROSE - 12] = sText_AttackerSpecialDefenseRose,
    [STRINGID_ATTACKER_SPEED_ROSE - 12] = sText_AttackerSpeedRose,
    [STRINGID_ATTACKER_ACCURACY_ROSE - 12] = sText_AttackerAccuracyRose,
    [STRINGID_ATTACKER_EVASIVENESS_ROSE - 12] = sText_AttackerEvasivenessRose,
    [STRINGID_ATTACKER_ATTACK_SHARPLYROSE - 12] = sText_AttackerAttackSharplyRose,
    [STRINGID_ATTACKER_DEFENSE_SHARPLYROSE - 12] = sText_AttackerDefenseSharplyRose,
    [STRINGID_ATTACKER_SPECIAL_ATTACK_SHARPLYROSE - 12] = sText_AttackerSpecialAttackSharplyRose,
    [STRINGID_ATTACKER_SPECIAL_DEFENSE_SHARPLYROSE - 12] = sText_AttackerSpecialDefenseSharplyRose,
    ...
    [STRINGID_SALT_CIRCLE - 12] = sText_BlockOnEntry,
    ...
    [STRINGID_PLAYERGOTBP - 12] = sText_PlayerGotBP,
    ...
    [STRINGID_HEAVYSPIKESSCATTERED - 12] = sText_HeavySpikesScattered,
    [STRINGID_PKMNALREADYTYPE - 12] = sText_PkmnAlreadyType,
    [STRINGID_PKMNCUTHPRAISEDSTATS - 12] = sText_PkmnCutHPRaisedStats,
    [STRINGID_PKMNAFFLICTEDBYSALTCURE - 12] = sText_PkmnAfflictedBySaltCure,
    [STRINGID_PKMN_SWITCHED_FIELD_EFFECTS - 12] = sText_PkmnSwitchedFieldEffects,
    [STRINGID_PKMNTELLCHILLINGRECEPTIONJOKE - 12] = sText_PkmnTellChillingReceptionJoke,
    [STRINGID_SHEDITSTAIL - 12] = sText_ShedItsTail,
    [STRINGID_GHASTLY_ECHO - 12] = sText_GhastlyEcho,
    [STRINGID_PKMNREVIVEDREADYTOFIGHT - 12] = sText_PkmnRevivedReadyToFight,
    ...
    [STRINGID_TRICKROOMSTARTS - 12] = sText_TrickRoomStarts,
    ...
    [STRINGID_EXTRASKILL_TERRAIN - 12] = sText_ExtraSkillTerrain,
    [STRINGID_EXTRASKILL_STEADYSTATSBOOST - 12] = sText_ExtraSkillSteadyStatsBoost,
    [STRINGID_EXTRASKILL_POSTURE - 12] = sText_ExtraSkillPosture,
    [STRINGID_EXTRASKILL_STATUSONTEAM - 12] = sText_ExtraSkillStatusOnTeam,
    [STRINGID_EXTRASKILL_LASTSTAND - 12] = sText_ExtraSkillLastStand,
    [STRINGID_EXTRASKILL_MATBLOCK - 12] = sText_ExtraSkillMatBlock,
    [STRINGID_EXTRASKILL_WOEUPONYE - 12] = sText_ExtraSkillWoeUponYe,
    [STRINGID_EXTRASKILL_FORESIGHT - 12] = sText_ExtraSkillForesight,
    [STRINGID_EXTRASKILL_EMBARGO - 12] = sText_ExtraSkillEmbargo,
    [STRINGID_EXTRASKILL_NOPROTECT - 12] = sText_ExtraSkillNoProtect,
    [STRINGID_EXTRASKILL_SMACKDOWN - 12] = sText_ExtraSkillWindSmackDown,
    [STRINGID_EXTRASKILL_REFLECT - 12] = sText_ExtraSkillReflect,
    [STRINGID_EXTRASKILL_LIGHTSCREEN - 12] = sText_ExtraSkillLightscreen,
    [STRINGID_EXTRASKILL_LUCKY_CHANT - 12] = sText_ExtraSkillLuckyChant,
    [STRINGID_EXTRASKILL_PERMA_WIDEGUARD - 12] = sText_ExtraSkillPermaWideGuard,
    ...
    [STRINGID_EXTRA_ABILITIES_1 - 12] = sText_ExtraSkillAbility1,
    [STRINGID_EXTRA_ABILITIES_2 - 12] = sText_ExtraSkillAbility2,
...
const u16 gWrappedStringIds[] = 
{
    ...
    [B_MSG_PKMNCLAMPED] = STRINGID_PKMNCLAMPED,
    [B_MSG_PKMNTRAPPEDINVORTEX] = STRINGID_PKMNTRAPPEDINVORTEX,
...
const u16 gWeatherCleared[] = 
{
    ...
    [B_MSG_SUN_ENDS] = STRINGID_SUNLIGHTFADED,
    [B_MSG_RAIN_ENDS] = STRINGID_RAINSTOPPED,
...
const u16 gBallEscapeStringIds[] = {[BALL_NO_SHAKES] = STRINGID_PKMNBROKEFREE,
                                    [BALL_1_SHAKE] = STRINGID_ITAPPEAREDCAUGHT,
                                    [BALL_2_SHAKES] = STRINGID_AARGHALMOSTHADIT,
                                    [BALL_3_SHAKES_FAIL] = STRINGID_SHOOTSOCLOSE};

const u8 *const gStatNamesTable[NUM_BATTLE_STATS] = {
    gText_HP3, gText_Attack, gText_Defense, gText_Speed, gText_SpAtk, gText_SpDef, sText_Accuracy, sText_Evasiveness};
...
const u16 gTrainerItemCuredStatusStringIds[] = {[AI_HEAL_CONFUSION] = STRINGID_PKMNSITEMSNAPPEDOUT,
...
const u8 *const gRoundsStringTable[DOME_ROUNDS_COUNT] = {
    [DOME_ROUND1] = sText_Round1, [DOME_ROUND2] = sText_Round2, [DOME_SEMIFINAL] = sText_Semifinal, [DOME_FINAL] = sText_Final};

// Unused
static const u8 *const sStatNamesTable2[] = {gText_HP3, gText_SpAtk, gText_Attack, gText_SpDef, gText_Defense, gText_Speed};

// For displaying names of invalid moves
static const u8 sATypeMove_Table[][NUMBER_OF_MON_TYPES - 1] = {
    [TYPE_NORMAL] _("a Normal move"), [TYPE_FIGHTING] _("a Fighting move"),  [TYPE_FLYING] _("a Flying move"),   [TYPE_POISON] _("a Poison move"),
    [TYPE_GROUND] _("a Ground move"), [TYPE_ROCK] _("a Rock move"),          [TYPE_BUG] _("a Bug move"),         [TYPE_GHOST] _("a Ghost move"),
    [TYPE_STEEL] _("a Steel move"),   [TYPE_MYSTERY] _("a ??? move"),        [TYPE_FIRE] _("a Fire move"),       [TYPE_WATER] _("a Water move"),
    [TYPE_GRASS] _("a Grass move"),   [TYPE_ELECTRIC] _("an Electric move"), [TYPE_PSYCHIC] _("a Psychic move"), [TYPE_ICE] _("an Ice move"),
    [TYPE_DRAGON] _("a Dragon move"), [TYPE_DARK] _("a Dark move"),          [TYPE_FAIRY] _("a Fairy move"),     [TYPE_STELLAR] _("a Stellar move"),
};
...
static const struct BattleWindowText *const sBattleTextOnWindowsInfo[] = {sTextOnWindowsInfo_Normal, sTextOnWindowsInfo_Arena};
            ...
            if (gBattleTypeFlags & BATTLE_TYPE_TRAINER) {
                ...
                if (gBattleTypeFlags & BATTLE_TYPE_LEGENDARY)
                    stringPtr = sText_LegendaryPkmnAppeared;
                         ...
                         IsValidForBattle(&gEnemyParty[gBattlerPartyIndexes[gActiveBattler ^ BIT_FLANK]]))  // interesting, looks like they had something
                                                                                                            // planned for wild double battles
...
u32 BattleStringExpandPlaceholdersToDisplayedString(const u8 *src) { return BattleStringExpandPlaceholders(src, gDisplayedStringBattle); }
...
static void GetBattlerNick(u32 battlerId, u8 *dst) {
    ...
    if (illusionMon != NULL) mon = illusionMon;
...
static const u8 *BattleStringGetOpponentNameByTrainerId(u16 trainerId, u8 *text, u8 multiplayerId, u8 battlerId) {
    ...
    if (gBattleTypeFlags & BATTLE_TYPE_SECRET_BASE) {
        u32 i;
        for (i = 0; i < ARRAY_COUNT(gBattleResources->secretBase->trainerName); i++) text[i] = gBattleResources->secretBase->trainerName[i];
        text[i] = EOS;
            ...
            switch (*src) {
                case B_TXT_BUFF1:
                    if (gBattleTextBuff1[0] == B_BUFF_PLACEHOLDER_BEGIN) {
                        ...
                        if (toCpy == NULL) toCpy = gBattleTextBuff1;
                    }
                    break;
                case B_TXT_BUFF2:
                ...
                case B_TXT_ACTIVE_NAME2:  // active battlerId name with prefix, no illusion
                    if (GetBattlerSide(gActiveBattler) == B_SIDE_PLAYER) {
                        if (isMonNicknamed(&gPlayerParty[gBattlerPartyIndexes[gActiveBattler]])) {
                            ...
                            SpeciesEnum species = GetMonData(&gPlayerParty[gBattlerPartyIndexes[gActiveBattler]], MON_DATA_SPECIES, NULL);
                        ...
                        if (isMonNicknamed(&gEnemyParty[gBattlerPartyIndexes[gActiveBattler]])) {
                            ...
                            SpeciesEnum species = GetMonData(&gEnemyParty[gBattlerPartyIndexes[gActiveBattler]], MON_DATA_SPECIES, NULL);
                            StringCopy(text, gSpeciesNames[species]);
                            StringGetEnd12(text);
                        }
                    }
                ...
                case B_TXT_TRAINER1_NAME:  // trainer1 name
                    toCpy =
                        BattleStringGetOpponentNameByTrainerId(gTrainerBattleOpponent_A, text, multiplayerId, GetBattlerAtPosition(B_POSITION_OPPONENT_LEFT));
                    break;
                ...
                case B_TXT_TRAINER2_NAME:
                    toCpy =
                        BattleStringGetOpponentNameByTrainerId(gTrainerBattleOpponent_B, text, multiplayerId, GetBattlerAtPosition(B_POSITION_OPPONENT_RIGHT));
                    break;
                ...
                case B_TXT_ATK_TRAINER_CLASS:
                    switch (GetBattlerPosition(gBattlerAttacker)) {
                        case B_POSITION_PLAYER_RIGHT:
                            if (gBattleTypeFlags & BATTLE_TYPE_INGAME_PARTNER) toCpy = gTrainerClassNames[GetFrontierOpponentClass(gPartnerTrainerId)];
                            break;
                        case B_POSITION_OPPONENT_LEFT:
                            toCpy = BattleStringGetOpponentClassByTrainerId(gTrainerBattleOpponent_A);
                            break;
...
static void IllusionNickHack(u32 battlerId, u32 partyId, u8 *dst) {
    ...
    if (GetMonAbility(mon) == ABILITY_ILLUSION) {
        ...
        for (i = PARTY_SIZE - 1; i >= 0; i--) {
            id = i;
            if (GetMonData(&gEnemyParty[id], MON_DATA_SANITY_HAS_SPECIES) && GetMonData(&gEnemyParty[id], MON_DATA_HP) && &gEnemyParty[id] != mon &&
...
static void ChooseMoveUsedParticle(u8 *textBuff) {
    ...
    while (counter != MAX_MON_MOVES) {
        if (sGrammarMoveUsedTable[i] == 0) counter++;
        if (sGrammarMoveUsedTable[i++] == gBattleMsgDataPtr->currentMove) break;
    }
...
static void ChooseTypeOfMoveUsedString(u8 *dst) {
    ...
    while (counter != MAX_MON_MOVES) {
        if (sGrammarMoveUsedTable[i] == MOVE_NONE) counter++;
        if (sGrammarMoveUsedTable[i++] == gBattleMsgDataPtr->currentMove) break;
    }
...
PpCountQuality GetCurrentPpToMaxPpState(u8 currentPp, u8 maxPp) {
    if (maxPp == currentPp) {
        ...
        if (currentPp == 0) return PP_NO_PP;
        if (currentPp <= maxPp / 4) return PP_SOME;
        if (currentPp > maxPp / 2) return PP_MANY;
    }
...
static u32 GetEnemyMonCount(bool32 onlyAlive) {
    ...
    for (i = 0; i < PARTY_SIZE; i++) {
        ...
        if (species != SPECIES_NONE && species != SPECIES_EGG && (!onlyAlive || GetMonData(&gEnemyParty[i], MON_DATA_HP, NULL))) count++;
    }
...
static bool32 IsBattlerHpLow(u32 battler) {
    if ((gBattleMons[battler].hp * 100) / max(1, gBattleMons[battler].maxHP) < 25)
        return TRUE;
    else
        return FALSE;
}
...
bool32 ShouldDoTrainerSlide(u32 battlerId, u32 trainerId, u32 which) {
    ...
    if (!(gBattleTypeFlags & BATTLE_TYPE_TRAINER) || GetBattlerSide(battlerId) != B_SIDE_OPPONENT) return FALSE;
        ...
        if (trainerId == sTrainerSlides[i].trainerId) {
            ...
            switch (which) {
                ...
                case TRAINER_SLIDE_LAST_LOW_HP:
                    if (sTrainerSlides[i].msgLastLowHp != NULL && GetEnemyMonCount(TRUE) == 1 && IsBattlerHpLow(battlerId) &&
